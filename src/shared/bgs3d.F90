...
implicit none
private
public :: gs3dst, gather_3d, gather_chk, scatter_3d, scatter_bdy
...
! =====================================================================
 ...
 implicit none
#include "mpif.h"
 real(8), intent(in ) ::  qchk(nx         , ny         , kstr:kend)
 real(8), intent(out) :: qchkg(igstr:igend, jgstr:jgend, kstr:kend)
 integer  ::   i, j, ijkg, k,  n
