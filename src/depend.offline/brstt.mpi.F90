...
#include "mpif.h"
   ...
   real(8), save ::    buf2(nxg, nyg)      ,   buf3(nxg, nyg, nz)
   real(8), save ::     g2d(nxgdim, nygdim),    g3d(nxgdim, nygdim, nzdim)
...
!---- for gradsgt
     ...
     &        idate(4), idate(5), idate(6), ' '
         ...
         write(chead(29), '(a8,i3)') 'OCLONTPT', nxg
         write(chead(30), '(i16)') 1
         write(chead(31), '(i16)') nxg
 
         write(chead(32), '(a8,i3)') 'OCLATTPT', nyg
